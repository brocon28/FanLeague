...
global $school;
$school = getSchool($connection, $username);
...
$schoolInfo = getSchoolInfo($connection);
...
function generateRankMessage($rank, $userPoints) {
   ...
   global $topItem;
    if ($rank == 1) {
        ...
        $message = "You're THE TOP DEVIL, Welcome to the top";
    } elseif ($rank <= 10) {
      ...
      <div class="container">
         ...
         <div class="sidebar">
            <div class="sidebar-top">
               <h1 class="league-title"><?php echo $school; ?> Fan League</h1>
